package com.xinze.haoke.module.main.adapter;
...
public class MyRecycleViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            if (icon != 0) {
                ...
                viewHolder.rvTitle.setCompoundDrawables(null, null, null, null);
            }
    ...
    public void update(ArrayList<MyRecycleViewItem> myRecycleViewItems) {
        mBS = myRecycleViewItems;
