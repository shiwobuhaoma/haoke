package com.xinze.haoke.module.main.activity;
...
import com.xinze.haoke.config.MainConfig;
...
public class MainActivity extends BaseActivity implements IMainView, DownloadListener, EasyPermissions.PermissionCallbacks {
    ...
    private void initViewPager() {
        ...
        mVp.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (fragments.get(position) == sendOrder) {
    ...
    private void checkUpdate() {
        ...
        mPresenter.checkUpdate(AppConfig.DRIVER_ANDROID, AppConfig.CONSIGNOR_UPDADE);
    }
