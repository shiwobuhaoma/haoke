package com.xinze.haoke.module.certification.bean;
 ...
 * 认证界面条目
 */
public class CompanyRecycleViewItem {
    ...
    public CompanyRecycleViewItem(String leftText, boolean isShowRightArrow, boolean isShowSpace, boolean isShowBottomLine, boolean isShowMiddleText, String middleHintText, String leftBitmap) {
    ...
    public CompanyRecycleViewItem(int leftText, boolean isShowRightArrow, boolean isShowSpace, boolean isShowBottomLine, String middleHintText, boolean isShowMiddleText) {
        this.isShowRightArrow = isShowRightArrow;
        this.isShowMiddleText = isShowMiddleText;
        this.isShowSpace = isShowSpace;
        this.isShowBottomLine = isShowBottomLine;
