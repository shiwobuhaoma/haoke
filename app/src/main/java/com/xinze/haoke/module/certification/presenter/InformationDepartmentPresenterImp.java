...
public class InformationDepartmentPresenterImp extends BasePresenterImpl<ICertificationView> implements ICertificationPresenter {
    private InformationDepartmentCertificationActivity mCertificationActivity;
    public InformationDepartmentPresenterImp(ICertificationView mPresenterView, Context mContext) {
        super(mPresenterView, mContext);
        mCertificationActivity = (InformationDepartmentCertificationActivity)mPresenterView;
