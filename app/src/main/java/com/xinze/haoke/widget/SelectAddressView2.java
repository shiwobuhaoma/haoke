...
import com.xinze.haoke.widget.adapter.AddressAdapter;
 ...
 * @author lxf
 */
public class SelectAddressView2 extends LinearLayout implements AddressAdapter.OnItemClickListener {
    ...
    public SelectAddressView2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SelectAddressView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        switch (view.getId()) {
            case R.id.address_item:
                ...
                if (provinceStr.equals(mAddress)) {
                    ...
                    sb.append(name);
                    String id = address.getId();
                    mOnSelectAddressListener.selectAddress(sb.toString(), id);
                    sb.setLength(0);
                    setViewGone();
                }
    ...
    public void setmOnSelectAddressListener(OnSelectAddressListener2 mOnSelectAddressListener) {
        this.mOnSelectAddressListener = mOnSelectAddressListener;
    }

    public OnSelectAddressListener2 mOnSelectAddressListener;
