...
public class AppConfig {
     ...
     * ios
     */
    public static final String CONSIGNOR_IOS = "1";

    /**
     * android
     */
    public static final String DRIVER_ANDROID = "0";

    /**
     * 货主端轮播图
     */
    public static final String CONSIGNOR_BANNER = "0";

    /**
     * 司机端轮播图
     */
    public static final String DRIVER_BANNER = "1";
    /**
     * 货主端版本更新
     */
    public static final String CONSIGNOR_UPDADE = "0";

    /**
     * 司机端版本更新
     */
    public static final String DRIVER_UPDADE = "1";
    /**
     * 司机端
     */
