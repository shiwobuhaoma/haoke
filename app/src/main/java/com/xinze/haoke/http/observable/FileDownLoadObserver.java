package com.xinze.haoke.http.observable;
...
// /下载成功的回调
    ...
    /**
     * 将文件写入本地 * @param responseBody 请求结果全体 * @param destFileDir 目标文件夹 * @param destFileName 目标文件名 * @return 写入完成的文件 * @throws IOException IO异常
     */
